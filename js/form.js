document.addEventListener("DOMContentLoaded", function () {
  ...
  style.textContent = `
    ...
    .request-option-list { display: grid; grid-template-columns: repeat(3, minmax(0, 1fr)); grid-auto-rows: 1fr; gap: clamp(10px, 2vw, 14px); align-items: stretch; }
    ...
    @media screen and (max-width: 600px) {
      ...
      .request-option-list { grid-template-columns: repeat(3, minmax(0, 1fr)); gap: clamp(10px, 3vw, 14px); }
