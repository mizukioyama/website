document.addEventListener("DOMContentLoaded", function () {
  ...
  style.textContent = `
    ...
    .request-options legend { margin-bottom: .85rem; font-size: var(--type-form-option-legend-size); font-weight: 300; letter-spacing: 1px; opacity: .65; }
    ...
    .form-status { min-height: 1.5em; margin: 1rem 0 0; font-size: var(--type-form-status-size); opacity: .7; }
    ...
    @media screen and (min-width: 601px) {
      #thanksModal .modal-content p { font-size: var(--type-form-modal-body-size) !important; }
    }
    #thanksModal .close { position: absolute !important; top: .8rem !important; right: .9rem !important; display: grid !important; place-items: center !important; margin: 0 !important; padding: 0 !important; float: none !important; width: 2.5rem !important; height: 2.5rem !important; line-height: 1 !important; font-family: Arial, sans-serif !important; font-size: var(--type-form-modal-close-size) !important; font-weight: 200 !important; color: var(--inv) !important; opacity: .72 !important; cursor: pointer !important; background: transparent !important; border: 0 !important; }
    ...
    @media screen and (max-width: 600px) {
      ...
      .request-option-list label { min-height: 0; margin: 0 !important; padding: 2px 0; background: transparent; font-size: clamp(10.88px, 2.8vw, 13.12px); }
      .request-option-list label span { font-size: clamp(9.5744px, 2.464vw, 11.5456px); }
