document.addEventListener("DOMContentLoaded", function () {
  ...
  style.textContent = `
    ...
    @media screen and (max-width: 600px) {
      ...
      .request-option-list { grid-template-columns: repeat(3, minmax(0, 1fr)); gap: 12px; }
      .request-option-list label { min-height: 3.75rem; margin: 0 !important; padding: .3rem 0 .4rem; background: transparent; }
