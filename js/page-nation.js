function setupCategoryFilter() {
    ...
    function renderGallery() {
        ...
        pageItems.forEach(item => {
            ...
            div.className = "work";
            div.innerHTML = `
            <p class="noise cg-text" style="font-size: 22.4px; font-weight: 500; position: absolute; top: -5rem; left: 1%; width: max-content; letter-spacing: 0; justify-content: flex-start; padding: 0; margin: 0 !important; border-bottom: 1px solid; line-height: 2;">
    ...
    modalBox.innerHTML = `
        <div class="work-img">
            ...
            <div class="modal-text">
                ...
                ${hasLink ? `
                <a href="${item.link}" class="noise" style="font-size: 25.6px; margin-top: 1vmin; border-bottom: 3px solid;" rel="noopener" target="_blank">${buttonLabel} More</a>
                ` : ""}
                <p>${inquiryMessage}</p>
                <a href="contact.html" class="noise" style="font-size: 25.6px; margin-top: 1vmin; border-bottom: 3px solid;">Contact</a>
